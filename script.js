...
let createProductCards = async () => {
    ...
    // pas 1: i = 0, i < 20 (true), se executa ce este in for, i = 1
    // pas 2: i = 1, i < 20 (true), se executa ce este in for, i = 2
    // pas 3: i = 2, i < 20 (true), se executa ce este in for, i = 3
    // ...
    // pas 21: i = 20, i < 20 (false), NU se executa ce este in for
    for(let i = 0;i < data.length;i++) {
        ...
        // aici am adaugat imaginea in card
...
let addToCart = (product, data) => {
    ...
    document.querySelector(".default-paragraph-sidebar").style.display = cartProducts.length >= 0 ?  "none" : "block";
    
    cartProductsContainer.innerHTML = '';

    for (let i = 0;i < cartProducts.length;i++) {
        let productSection = document.createElement('div');
        productSection.classList.add("navbar-container")
        productSection.style.paddingBottom = "20px";
        ...
        productData.innerHTML = `
            ...
            <div class = "navbar-container">
                <p class = "pharagraphs-cart"> Price: $${cartProducts[i].price} </p>
                <p class = "pharagraphs-cart"> Total: $${cartProducts[i].price * cartProducts[i].quantity} </p>
            </div>
            ...
            let quantitySpan = productData.querySelector('.cart-product-quantity');
            plusButton.addEventListener('click', () => {
                let currentQuantity = parseInt(quantitySpan.innerText);
                currentQuantity++;
                quantitySpan.innerText = currentQuantity;
                cartProducts[i].quantity++;
                quantitySpan.innerText = cartProducts[i].quantity;
                let total = cartProducts[i].price * cartProducts[i].quantity;
                productData.querySelector('.pharagraphs-cart:nth-child(2)').innerText = `Total: $${total.toFixed(2)}`;
                calculateTotal();
                updateCartBadge();
            });
            ...
            minusButton.addEventListener('click', () => {
             ...
             let mainTotal = document.querySelector(".main-total");
             ...
             let calculateTotal = () => {
                ...
                mainTotal.innerText = `Total: $${total.toFixed(2)}`;
            }
...
searchIcon.addEventListener('click', () => {
    ...
    let cardContainers = document.querySelectorAll('.product-card-container');
    cardContainers.forEach(cardContainer => {
        let titleElement = cardContainer.querySelector('.product-card-title');
        let descriptionElement = cardContainer.querySelector('.product-card-description');
